...
//
// This only covers the answer-generation call. OpenRouter has no embeddings
// endpoint at all (it only implements chat/completions) -- see
// src/embeddings.ts and the README gap-analysis for how this demo gets real
// embeddings without a second paid API key.
